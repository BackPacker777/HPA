...
class DataHandler {
	constructor(whichAjax, data) {
     ...
     savePDF(data) {
          let htmlFile = FS.readdirSync('./public/views/results.html', 'utf8');
          let options = ({ format: 'Letter'});
          PDF.create(htmlFile, options).toFile('./data/registrations/camper.pdf', (err, res) => {
               console.log(res);
          });
     }
